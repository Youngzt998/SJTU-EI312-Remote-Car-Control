...
public class VoiceActivity extends AppCompatActivity implements EventListener {
    ...
    public void onEvent(String name, String params, byte[] data, int offset, int length) {
        ...
        //Toast.makeText(VoiceActivity.this, params, Toast.LENGTH_SHORT).show();

        Log.d("voice", "name: " + name + "\nparams: " + params );
        ...
        try {
            if(params.contains("左"))
            {
                Toast.makeText(VoiceActivity.this, "成功识别左", Toast.LENGTH_SHORT).show();
                resultString = "1";
            }else if(params.contains("右"))
            {
                Toast.makeText(VoiceActivity.this, "成功识别右", Toast.LENGTH_SHORT).show();
                resultString = "2";
            }else if(params.contains("前"))
            {
                Toast.makeText(VoiceActivity.this, "成功识别前", Toast.LENGTH_SHORT).show();
                resultString = "3";
            }else if(params.contains("后"))
            {
                Toast.makeText(VoiceActivity.this, "成功识别后", Toast.LENGTH_SHORT).show();
                resultString = "4";
            }
